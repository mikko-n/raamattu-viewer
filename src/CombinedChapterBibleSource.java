...
public class CombinedChapterBibleSource extends BibleSource {
    ...
    public CombinedChapterBibleSource(GoBible goBible) throws IOException, TranslationNotFoundException {
        this(goBible, goBible.getTranslation());
        this.goBible = goBible;
    }

    public CombinedChapterBibleSource(GoBible goBible, String translationRoot) throws IOException, TranslationNotFoundException {
        super(goBible);
